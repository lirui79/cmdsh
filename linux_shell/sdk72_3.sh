...
xtor_memory_test -x 2 -o 0x800000 -m write_from_file -f /home/fpga/data/testcase.bin  -l 0x100000

xtor_memory_test -x 2 -o 0xC00000 -m write_from_file -f /home/fpga/data/srcase.bin    -l 0x100000

# CMD == 0
if [[ $CMD == 0 ]] ; then

#xtor_memory_test -x 2 -o 0x1000000 -m write_from_file -f /home/fpga/data/firmware_64.bin  -l 992832
xtor_memory_test -x 2 -o 0x1000000 -m write_from_file -f /home/fpga/data/firmware_38.bin  -l 997952
...
xtor_memory_test -x 2 -o 0xFE000000 -m write_from_file -f /home/fpga/data/YUV_352x288_B8_F50.yuv  -l 0x740400
...
xtor_memory_test -x 2 -o 0xC0000000 -m write_from_file -f /home/fpga/data/we_8192x8192.yuv -l 0x1E000000
